...
public:
    ...
    static B64 generate_white_pawn_jump(const B64 all_pieces, B64 piece) {
        B64 moves = 0;
    ...
    static B64 generate_black_pawn_jump(const B64 all_pieces, B64 piece) {
        B64 moves = 0;
    ...
    static B64 generate_bishop_moves(const B64 all_pieces, B64 piece) {
        B64 moves = 0;
    ...
    static B64 generate_rook_moves(const B64 all_pieces, B64 piece) {
        B64 moves = 0;
    ...
    static B64 generate_queen_moves(const B64 all_pieces, B64 piece) {
        B64 moves = 0;
...
private:
    ...
    static void prepare_king_moves() {
    ...
    static void prepare_knight_moves() {
        B64 current_board = 1ULL;
        for (size_t i = 0; i < 64; i++) {
    ...
    static void prepare_white_pawn_moves() {
        B64 current_board = 1ULL;
    ...
    static void prepare_black_pawn_moves() {
        B64 current_board = 1ULL;
    ...
    static void prepare_pawn_moves() {
