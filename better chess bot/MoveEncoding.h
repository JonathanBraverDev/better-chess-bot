...
// bit rights
constexpr int WHITE_CASTLE_RIGHTS_LENGTH = 2;
constexpr int BLACK_CASTLE_RIGHTS_LENGTH = 2;
...
static_assert(ORIGIN_INDEX_LENGTH + DESTINATION_INDEX_LENGTH + WHITE_CASTLE_RIGHTS_LENGTH + BLACK_CASTLE_RIGHTS_LENGTH + 
...
constexpr int WHITE_CASTLE_RIGHTS_OFFSET = DESTINATION_INDEX_OFFSET + DESTINATION_INDEX_LENGTH;
constexpr int BLACK_CASTLE_RIGHTS_OFFSET = WHITE_CASTLE_RIGHTS_OFFSET + WHITE_CASTLE_RIGHTS_LENGTH;
constexpr int VALID_EN_PASSANT_OFFSET = BLACK_CASTLE_RIGHTS_OFFSET + BLACK_CASTLE_RIGHTS_LENGTH;
...
constexpr BitMove WHITE_CASTLE_RIGHTS_MASK = 0b11 << WHITE_CASTLE_RIGHTS_OFFSET;
constexpr BitMove BLACK_CASTLE_RIGHTS_MASK = 0b11 << BLACK_CASTLE_RIGHTS_OFFSET;
...
static_assert((ORIGIN_INDEX_MASK | DESTINATION_INDEX_MASK | WHITE_CASTLE_RIGHTS_MASK | BLACK_CASTLE_RIGHTS_MASK |
...
constexpr BitMove BIT_RIGHTS_MASK = 0b11111111 << WHITE_CASTLE_RIGHTS_OFFSET;

static_assert((WHITE_CASTLE_RIGHTS_MASK | BLACK_CASTLE_RIGHTS_MASK | VALID_EN_PASSANT_MASK | EN_PASSANT_INDEX_MASK)
