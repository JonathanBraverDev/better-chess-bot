...
constexpr int UNUSED_SPACE_LENGTH = 9;
constexpr int MOVE_TYPE_LENGTH = 5;
// sanity check
constexpr int TOTAL_LENGTH = ORIGIN_INDEX_LENGTH + DESTINATION_INDEX_LENGTH + MOVING_TYPE_LENGTH +
...
constexpr int MOVING_TYPE_OFFSET = DESTINATION_INDEX_OFFSET + DESTINATION_INDEX_LENGTH;
...
constexpr BitMove UNUSED_SPACE_MASK = 0b111111111 << CAPTURED_TYPE_OFFSET;
constexpr BitMove MOVE_TYPE_MASK = 0b11111 << MOVE_TYPE_OFFSET;
// sanity check
constexpr BitMove TOTAL_MASK = ORIGIN_INDEX_MASK | DESTINATION_INDEX_MASK |
