...
constexpr B64 INNITIAL_WHITE_QUEENS = D1;
constexpr B64 INNITIAL_WHITE_KING = E1;
...
constexpr B64 INNITIAL_BLACK_QUEENS = D8;
constexpr B64 INNITIAL_BLACK_KING = E8;
...
constexpr bool INNITIAL_PLATER_WHITE = true;
