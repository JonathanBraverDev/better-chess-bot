...
inline std::vector<SidedPosition> all_possible_positions(const GameState state) { return all_possible_positions(state.sided_position); };
inline std::vector<SidedPosition> possible_evade_positions(const GameState state) { return possible_evade_positions(state.sided_position); };