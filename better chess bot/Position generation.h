...
void possible_pawn_positions(std::vector<SidedPosition>& positions, const SidedPosition& sided_position, const B64 piece, const B64 blockers, const B64 opponent_pieces);
...
void tile_move_positions(std::vector<SidedPosition>& positions, const SidedPosition sided_position, const B64 target_board_bit, const PieceType piece_type, B64 possible_moves = NULL);
...
inline void all_possible_positions(std::vector<SidedPosition> positions, const GameState state) { all_possible_positions(positions, state.sided_position); };
inline void possible_evade_positions(std::vector<SidedPosition> positions, const GameState state) { possible_evade_positions(positions, state.sided_position); };