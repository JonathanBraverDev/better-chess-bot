...
void possible_capture_positions(std::vector<BoardPosition>& positions, BoardPosition& new_position, B64 potential_moves, const bool is_white, const B64 piece, B64& current_pieces, const B64& enemy_pawns, const B64& enemy_knights, const B64& enemy_bishops, const B64& enemy_rooks, const B64& enemy_queens, const B64* move_source = nullptr);
