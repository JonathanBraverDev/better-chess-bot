...
constexpr PieceType PieceTypes[] = {PieceType::KING,   PieceType::PAWN,
...
inline constexpr AttackerType toAttackerType(PieceType type) {
  constexpr AttackerType table[] = {
      AttackerType::NONE,   AttackerType::KING,   AttackerType::PAWN,
      AttackerType::KNIGHT, AttackerType::BISHOP, AttackerType::ROOK,
      AttackerType::QUEEN,
  };
...
inline constexpr PieceType toPieceType(AttackerType type) {
  constexpr PieceType table[] = {
      PieceType::NONE,   PieceType::KING,   PieceType::QUEEN, PieceType::ROOK,
...
inline const std::string &pieceTypeToName(PieceType type) {
  static const std::string names[] = {"None",   "King", "Pawn", "Knight",
                                      "Bishop", "Rook", "Queen"};
