...
public:
    ...
    TEST_METHOD(Perft_Position1_StartPos) {
        ...
        Assert::AreEqual(20, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Perft_Position2_Kiwipete) {
        ...
        Assert::AreEqual(48, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Perft_Position3) {
        ...
        Assert::AreEqual(14, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Perft_Position4) {
        ...
        Assert::AreEqual(6, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Perft_Position5) {
        ...
        Assert::AreEqual(44, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Perft_Position6) {
        ...
        Assert::AreEqual(46, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Castling_White_BothSides) {
        ...
        Assert::AreEqual(26, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(EnPassant_White) {
        ...
        Assert::AreEqual(7, pos.getLegalMoves().size());
    }
    ...
    TEST_METHOD(Promotion_White) {
        ...
        Assert::AreEqual(9, pos.getLegalMoves().size());
    }
